package PublishTwilog::L10N::en_us;

use strict;
use base 'PublishTwilog::L10N';
use vars qw( %Lexicon );
%Lexicon = (
	'as_NAME' => 'PublishTwilog',
	'as_AUTHOR_NAME' => 'cool_ni_ikou',
	'as_DESCRIPTION' => 'PublishTwilog makes it easy to publish JSON Data of Access Ranking from Google Analytics, thus you can easily put AccessRanking List based on GADATA into contents.  ',
